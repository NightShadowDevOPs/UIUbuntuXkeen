export const normalizeProxyProtoKey = (type) => {
    ...
    let t = compact;
    // aliases / families
    if (raw === 'trojan-go' || t === 'trojango')
        t = 'trojan';
    if (t === 'shadowsocks' || t.startsWith('shadowsocks'))
        t = 'ss';
    if (t === 'hysteria' || t.startsWith('hysteria'))
        t = 'hy';
...
export const getProxyProtoLabel = (type) => {
