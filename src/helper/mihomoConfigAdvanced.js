...
const extractSniffText = (lines, snifferRange) => {
    if (!snifferRange)
        return '';
...
export const emptyAdvancedSectionsForm = () => ({
    tunEnable: '',
    tunStack: '',
    tunAutoRoute: '',
...
export const advancedSectionsFormFromConfig = (value) => {
...
export const upsertAdvancedSectionsInConfig = (value, form) => {
    const normalized = normalizeText(value);
    const lines = normalized.length ? normalized.split('\n') : [];
