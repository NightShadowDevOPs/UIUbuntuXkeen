...
На этом релизе обновлены метаданные продукта, добавлен GitHub Actions build/release pipeline и настроен rolling-канал для обновления UI через кнопку «Обновить».
...
Начиная с `v0.2.1`, GitHub Actions должны:
