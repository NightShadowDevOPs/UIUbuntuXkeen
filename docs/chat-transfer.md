...
Актуальный релиз для переноса: **v0.6.4**
...
- Текущий релиз линии: **v0.6.4**
- Последний подтверждённо рабочий релиз на сервере: **v0.2.10**
- Релиз **v0.6.4** привёл раздел **«Задачи»** к правильной модели: для провайдеров задаются URL их **3x-ui подписок**, и именно по этим ссылкам в Tasks выполняется SSL/TLS-опрос сертификатов. URL теперь можно редактировать прямо в таблице Tasks и в карточке провайдера, а терминология очищена от ложной модели «панелей управления».
...
- `v0.6.4` — Tasks alignment: 3x-ui subscription URLs and SSL flow
