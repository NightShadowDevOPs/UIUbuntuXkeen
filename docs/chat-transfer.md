...
- Текущий релиз линии: **v0.5.5**
- Последний подтверждённо рабочий релиз на сервере: **v0.2.10**
- Релиз **v0.5.5** — рабочий шаг по разделу **«Трафик»**: страница теперь показывает сводку по живым клиентам, таблицу состояний клиентов по IP (**Mihomo / VPN / bypass**), а также собирает live connections, host traffic/QoS и user-traffic в одном месте.
