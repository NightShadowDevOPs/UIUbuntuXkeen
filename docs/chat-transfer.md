...
- Текущий релиз линии: **v0.6.0**
- Последний подтверждённо рабочий релиз на сервере: **v0.2.10**
- Релиз **v0.6.0** — первый рабочий MVP по **SSL-проверке прокси-провайдеров**: в разделе **«Прокси-провайдеры»** появился отдельный workspace с действиями **«Проверить сейчас»** и **«Обновить SSL-кеш»**, таблицей сертификатов, сроками действия, временем последней проверки, URL и ошибками TLS/SSL.
