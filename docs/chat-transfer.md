...
Актуальный релиз для переноса: **v0.5.2**
...
- Текущий релиз линии: **v0.5.2**
- Последний подтверждённо рабочий релиз на сервере: **v0.2.10**
- Релиз **v0.5.2** — foundation-шаг по провайдерам: UI уже умеет смотреть на capabilities Ubuntu service и работать не только через legacy agent bridge.
