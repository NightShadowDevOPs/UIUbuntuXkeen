...
Актуальный релиз для переноса: **v0.5.5**
...
- Текущий релиз линии: **v0.5.6**
- Последний подтверждённо рабочий релиз на сервере: **v0.2.10**
- Релиз **v0.5.6** — практический hotfix по разделу **«Трафик»**: убран шумный `Network Error` при недоступной host telemetry, synthetic/system IP вроде `198.18.x.x` больше не маскируются под клиентов, degraded-режим **только Mihomo** теперь работает честно.
...
- `v0.5.6` — Трафик: practical hotfix synthetic IP и degraded telemetry
- `v0.5.7` — GEO-файлы, локальные правила и top rules
- `v0.5.8` — QoS / shaping foundation
- `v0.6.0` — Subscriptions / tasks operational parity
