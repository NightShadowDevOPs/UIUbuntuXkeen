...
- в `v0.2.6` шаг `Install dependencies` переведён в режим inline-диагностики: полный лог `pnpm install` печатается прямо в окне GitHub Actions между маркерами begin/end, после чего job явно завершается ошибкой, если установка не удалась.
