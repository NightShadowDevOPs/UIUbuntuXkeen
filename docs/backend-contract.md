...
Актуальная версия документа: **v0.6.56**  
...
## Provider SSL poller defaults (v0.6.56)
- `ULTRA_UI_SSL_WARN_DAYS=2` — default warning threshold for 3x-ui host certificates;
