...
На линии `v0.4.1` считаем допустимыми два режима backend-а:
...
На `v0.4.1` это **ещё не полноценный Ubuntu backend-service**.
...
## Что добавлено на UI-уровне в v0.4.1
