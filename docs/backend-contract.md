...
Актуальная версия документа: **v0.6.49**  
...
На `v0.6.49` в репозитории уже реализована первая рабочая версия такого сервиса.
