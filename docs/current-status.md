# Текущий статус — v0.6.29

- Текущая линия: **v0.6.29**
...
- `v0.6.29` переводит GitHub Actions install-step на `pnpm install --no-frozen-lockfile` и явно показывает drift между `package.json` и `pnpm-lock.yaml`.
