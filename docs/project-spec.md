...
Актуальная версия документа: **v0.2.0**  
Дата актуализации: **2026-03-30**

## 0. Статус документа

Документ соответствует релизу **v0.2.0**. На этом этапе зафиксированы не только целевая архитектура Ubuntu-линии, но и release-flow проекта: GitHub Actions должны собирать UI, публиковать versioned release и обновлять rolling-архив `dist.zip`, который используется встроенным механизмом обновления UI.
