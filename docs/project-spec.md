...
Актуальная версия документа: **v0.6.21**  
Дата актуализации: **2026-03-31**

## 0. Статус документа

Документ соответствует релизу **v0.6.21**. На этом этапе проект уже имеет рабочий release-flow и подтверждённый server update path на релизе **v0.2.10**.
