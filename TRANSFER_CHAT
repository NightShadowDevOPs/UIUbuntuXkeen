Prepared release: v0.6.30. v0.6.29 had invalid YAML syntax in `.github/workflows/build-ui.yml`; v0.6.30 repairs the workflow file.
...
Актуальный релиз для переноса: **v0.6.30**
...
- Прогнать workflow из `v0.6.30` и взять первую реальную ошибку, если build ещё не зелёный.
